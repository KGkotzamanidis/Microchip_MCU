...
void main(void){
    pin_Direction(RA_0,0x00);
    pin_Direction(RA_1,0x01);
    pin_Direction(RA_2,0x01);
    pin_Direction(RA_3,0x01);
    pin_Direction(RA_4,0x00);
    pin_Direction(RA_5,0x01);
    pin_Direction(RA_6,0x01);
    pin_Direction(RA_7,0x01);
    return;
}
