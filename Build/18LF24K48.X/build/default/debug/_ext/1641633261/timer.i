...
# 2 "<built-in>" 2
# 1 "../../Sources/18LF24K40/timer.c" 2
# 26 "../../Sources/18LF24K40/timer.c"
# 1 "../../Sources/18LF24K40/./../../Libraries/18LF24K40/timer.h" 1
# 29 "../../Sources/18LF24K40/./../../Libraries/18LF24K40/timer.h"
...
void sleep(void);
# 29 "../../Sources/18LF24K40/./../../Libraries/18LF24K40/timer.h" 2


uint8_t bytes[2];

void TMR0_Start(uint16_t timer,int clk_Prescale,int Postscaler,_Bool _16bit_Operation,_Bool ASYNC);
void TMR1_Start(uint16_t timer,const char* clk_select,int clk_Prescale,_Bool _16bit_Operation,_Bool SYNC);
void TMR2_Start(uint8_t timer,int clk_Prescale,int Postscaler);
void TMR3_Start(uint16_t timer,int clk_Prescale,_Bool _16bit_Operation);
void TMR4_Start(uint8_t timer,int clk_Prescale,int Postscaler);
void TMR5_Start(uint16_t timer,int clk_Prescale,_Bool _16bit_Operation);
...
void TMR5_Stop();
void TMR6_Stop();
# 26 "../../Sources/18LF24K40/timer.c" 2
# 37 "../../Sources/18LF24K40/timer.c"
void TMR0_Start(uint16_t timer,int clk_Prescale,int Postscaler,_Bool _16bit_Operation,_Bool ASYNC){
...
# 186 "../../Sources/18LF24K40/timer.c"
void TMR1_Start(uint16_t timer,const char* clk_select,int clk_Prescale,_Bool _16bit_Operation,_Bool SYNC){
    uint8_t var_Settings;
    uint8_t var_Prescale;
    uint8_t x;

    if(_16bit_Operation && SYNC){
        var_Settings = 0x7;
    }else if(_16bit_Operation && !SYNC){
        var_Settings = 0x3;
    }else if(!_16bit_Operation && SYNC){
        var_Settings = 0x5;
    }else if(!_16bit_Operation && !SYNC){
