...
# 2 "<built-in>" 2
# 1 "../../Sources/16F887/io.c" 2
# 27 "../../Sources/16F887/io.c"
# 1 "../../Sources/16F887/./../../Libraries/16F887/io.h" 1
# 30 "../../Sources/16F887/./../../Libraries/16F887/io.h"
...
# 88 "../../Sources/16F887/./../../Libraries/16F887/macros.h"
...
void sleep(void);
# 31 "../../Sources/16F887/./../../Libraries/16F887/io.h" 2
...
void pin_Direction(IO_PORT var_pin, uint8_t var_derection){
    ...
    switch(var_PortNumber){
        ...
        case 2:
            ...
            break;
        case 3:
            ((var_derection)? ((TRISD) |= (1<<(var_pin))): ((TRISD) &= ~(1<<(var_pin))));
            break;
        case 4:
            ((var_derection)? ((TRISE) |= (1<<(var_pin))): ((TRISE) &= ~(1<<(var_pin))));
            break;
    }
}
...
void write_Digital(IO_PORT var_pin, uint8_t value){
    ...
    switch(var_PortNumber){
        ...
        case 2:
            ...
            break;
        case 3:
            ((value)? ((PORTD) |= (1<<(var_pin))): ((PORTD) &= ~(1<<(var_pin))));
            break;
        case 4:
...
uint8_t read_Digital(IO_PORT var_pin){
    ...
    switch(var_PortNum){
        ...
        case 2:
            ...
            break;
        case 3:
            returnStatus = (((PORTD)&((1<<(var_pin))))!=0u);
            break;
        case 4:
