...
# 2 "<built-in>" 2
# 1 "../../Sources/16F887/uart.c" 2
# 26 "../../Sources/16F887/uart.c"
...
# 27 "../../Sources/16F887/uart.c" 2
# 1 "../../Sources/16F887/./../../Libraries/16F887/uart.h" 1
# 31 "../../Sources/16F887/./../../Libraries/16F887/uart.h"
# 1 "../../Sources/16F887/./../../Libraries/16F887/lcd.h" 1
# 31 "../../Sources/16F887/./../../Libraries/16F887/lcd.h"
...
# 32 "../../Sources/16F887/./../../Libraries/16F887/uart.h" 2
...
# 28 "../../Sources/16F887/uart.c" 2

#pragma warning push
#pragma warning disable 520

void UART_Init(uint32_t BaudRate){
    pin_Direction(RC_6, 0x00);
    pin_Direction(RC_7, 0x01);
    TXSTA = 0x20;
    RCSTA = 0x90;
...
void UART_setBaudRate(uint32_t BaudRate){
    ...
    if((BaudRate >= 2400) && (BaudRate <= 115200)){
        RegisterValue = (uint8_t)(uint32_t)((20000000 / (64*(uint32_t)BaudRate))-1);
    }
    else{
        RegisterValue = (uint8_t)(uint32_t)((20000000 / (64*(uint32_t)9600))-1);
    }
    SPBRG = RegisterValue;
}
