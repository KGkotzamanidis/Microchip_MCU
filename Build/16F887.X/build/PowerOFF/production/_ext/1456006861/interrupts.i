...
# 2 "<built-in>" 2
# 1 "../../Sources/16F887/interrupts.c" 2
# 26 "../../Sources/16F887/interrupts.c"
# 1 "../../Sources/16F887/./../../Libraries/16F887/interrupts.h" 1
# 28 "../../Sources/16F887/./../../Libraries/16F887/interrupts.h"
...
void sleep(void);
# 29 "../../Sources/16F887/./../../Libraries/16F887/interrupts.h" 2

_Bool is_intterupt();
void do_interrupt(void);
void set_external_INT(char triger_edge);
_Bool get_external_INT();
# 27 "../../Sources/16F887/interrupts.c" 2
...
# 28 "../../Sources/16F887/interrupts.c" 2
# 54 "../../Sources/16F887/interrupts.c"
_Bool is_intterupt(){
    if(T0IF){
        return 1;
    }
