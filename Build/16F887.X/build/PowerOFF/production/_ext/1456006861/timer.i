...
# 2 "<built-in>" 2
# 1 "../../Sources/16F887/timer.c" 2
# 26 "../../Sources/16F887/timer.c"
# 1 "../../Sources/16F887/./../../Libraries/16F887/timer.h" 1
# 30 "../../Sources/16F887/./../../Libraries/16F887/timer.h"
# 1 "A:\\Program_Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\stdbool.h" 1 3
# 31 "../../Sources/16F887/./../../Libraries/16F887/timer.h" 2
...
void sleep(void);
# 32 "../../Sources/16F887/./../../Libraries/16F887/timer.h" 2

void enable_TMR0(_Bool enable,char select_edge,char select_clock,_Bool enable_Prescaler,int set_Prescaler);
void set_TMR0(uint8_t timer);
uint8_t get_TMR0();
void enable_TMR1(_Bool enable,char select_clock,int set_Prescaler,_Bool enable_sychronize);
void set_TMR1(uint16_t time);
uint16_t get_TMR1();
void enable_TMR2(_Bool enable,int set_Prescaler,int set_Postscaler);
void set_TMR2(uint8_t time);
uint8_t get_TMR2();
# 27 "../../Sources/16F887/timer.c" 2
# 39 "../../Sources/16F887/timer.c"
void enable_TMR0(_Bool enable,char select_edge,char select_clock,_Bool enable_Prescaler,int set_Prescaler){
    if(enable){
        INTCONbits.GIE = 1;
        INTCONbits.PEIE = 1;
