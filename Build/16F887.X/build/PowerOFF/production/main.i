...
# 1 "./../../Libraries/16F887/analog.h" 1
# 30 "./../../Libraries/16F887/analog.h"
...
# 12 "E:\\Microchip\\xc8\\v2.41\\pic\\include\\c90\\stdio.h" 2 3
...
void sleep(void);
# 31 "./../../Libraries/16F887/analog.h" 2

void ADC_Init(_Bool a_negative_voltager, _Bool a_positive_voltag);
uint16_t read_Analog(uint8_t var_Channel);
# 15 "main.c" 2
# 1 "./../../Libraries/16F887/lcd.h" 1
# 31 "./../../Libraries/16F887/lcd.h"
# 1 "./../../Libraries/16F887/delay.h" 1
# 35 "./../../Libraries/16F887/delay.h"
void Delay_us(uint16_t us_count);
void Delay_ms(uint16_t ms_count);
void Delay_sec(uint16_t sec_count);
# 32 "./../../Libraries/16F887/lcd.h" 2
...
# 34 "./../../Libraries/16F887/lcd.h" 2
# 61 "./../../Libraries/16F887/lcd.h"
typedef struct{
...
void __attribute__((picinterrupt(("")))) IRS(void){
    return;
}
void main(void){
    ExternalClock_Init();
