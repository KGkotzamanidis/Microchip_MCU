...
# 31 "./../../Libraries/16F887/macros.h" 2
...
# 33 "./../../Libraries/16F887/macros.h" 2
# 1 "A:\\Program_Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\stdbool.h" 1 3
# 34 "./../../Libraries/16F887/macros.h" 2
# 90 "./../../Libraries/16F887/macros.h"
...
# 31 "./../../Libraries/16F887/oscillator.h"
void InternalClock_Init(int set_device_freq);
void ExternalClock_Init(void);
# 15 "main.c" 2

# 1 "./../../Libraries/16F887/io.h" 1
# 32 "./../../Libraries/16F887/io.h"
typedef enum{
...
# 1 "./../../Libraries/16F887/timer.h" 1
# 31 "./../../Libraries/16F887/timer.h"
void TMR0_enable(_Bool PSA,int Prescaler,char clk_src[],char edge_src[]);
_Bool TMR0_interrupt();

void TMR1_enable(char clk_src[],_Bool SYNC,_Bool LPSOC,int Prescaler);
void TMR1_set_timer(uint16_t time);
_Bool TMR1_interrupt();

void TMR2_enable(int Prescaler,int Postscaler);
void TMR2_set_timer(uint8_t timer);
_Bool TMR2_interrupt();
# 17 "main.c" 2


void __attribute__((picinterrupt(("")))) test(void){
    while(TMR1_interrupt()){
        write_Digital(RD_1,0x00);
        TMR1_set_timer(65534);
    }
    return;
}

void main(void){
    pin_Direction(RD_1,0x00);
    TMR1_enable("FOSC4",0,0,1);
    TMR1_set_timer(65534);
    ExternalClock_Init();
    write_Digital(RD_1,0x01);
